  ...
  return (
    <div class="bg-blue-400">
      <nav class="relative px-4 py-4 flex justify-between items-center">
        ...
        <div class="lg:hidden">
          <button class="navbar-burger flex items-center text-white-600 p-3" onClick={()=>{
        ...
        <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
          <li>
            <a class={`text-lg text-white hover:text-gray-500`} href="/" onClick={()=>{
              console.log("Home")
            }}>
              SMP
            </a>
          ...
          <li>
            <a class="text-lg text-white hover:text-gray-500" href="/nhs">
              NHS
            </a>
          </li>
          <li class="text-white">
          ...
          <li>
            <a class="text-lg text-white hover:text-gray-500" href="/input">
              Input-form
            </a>
          </li>
          <li class="text-white">
          ...
          <li>
            <a class="text-lg text-white hover:text-gray-500" href="/smpemployee">
              SMPEmployee
            </a>
          </li>
          <li class="text-white">
          ...
          <li>
            <a class="text-lg text-white hover:text-gray-500" href="/coming">
              Contact
            </a>
          </li>
        </ul>
      ...
      {mobilenav&&<div class="navbar-menu relative z-50">
